...
x_max = x_points[-1] + x_points[-1] * 0.1  # Adding 10% margin for better visualization
y_max = max(y_points) + max(y_points) * 0.1  # Adding 10% margin for better visualization
...
plt.text(x_max * 0.1, y_max * 0.9, optimal_text, fontsize=12, bbox=dict(facecolor='white', alpha=0.7))
